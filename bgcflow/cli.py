...
@main.command()
@click.argument('destination')
@click.option('--branch', default='main', help='BGCFlow branch. (DEFAULT: `dev-snakemake-wrapper`)')
def clone(**kwargs):
    """
...
@main.command()
@click.option('--bgcflow_dir', default='.', help='Location of BGCFlow directory. (DEFAULT: Current working directory)')
@click.option('--project', help='Initiate a new BGCFlow project. Insert project name: `bgcflow init --project <TEXT>`')
