...
The best way to send feedback is to file an issue at https://github.com/matinnuhamunada/bgcflow_wrapper/issues.
...
3. The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.com/matinnuhamunada/bgcflow_wrapper/pull_requests
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_bgcflow_wrapper
